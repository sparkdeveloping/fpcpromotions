...
export const videoStatuses = ["Needs recording", "Needs upload", "Uploaded", "Needs edit", "Needs review", "Ready to post", "Posted", "Optional"];
export const calendarTypes = ["Service", "Shoot", "Edit", "Post", "Approval", "Meeting", "Reminder"];
export const gearStatuses = ["Ready", "Needs check", "Check battery", "Out", "In use"];
...
export const serviceTemplates = [
  {
    ...
    contentBucket: "Service",
    folders: ["Service Info"],
    filePaths: [
      "Social/Shortform/Unedited/{date} {title}",
      "Social/Shortform/Edited/{date} {title}",
      "Social/Longform/Unedited/{date} {title}",
      "Social/Longform/Edited/{date} {title}",
      "ChurchView/Services/{date} {title}/Photos",
      "ChurchView/Services/{date} {title}/Graphics",
      "ChurchView/Services/{date} {title}/Notes",
      "ChurchView/Services/{date} {title}/Final Exports"
    ],
    suggestedVideos: [
  ...
  },
  {
    ...
    filePaths: [
      ...
      "Social/Longform/Unedited/{date} {title}",
      "Social/Longform/Edited/{date} {title}",
      "ChurchView/Services/{date} {title}/Worship",
      "ChurchView/Services/{date} {title}/Specials",
      "ChurchView/Services/{date} {title}/Final Exports"
    ],
    suggestedVideos: [
  ...
  },
  {
    ...
    filePaths: [
      ...
      "Social/Longform/Edited/{date} {title}",
      "ChurchView/Services/{date} {title}/Photos",
      "ChurchView/Services/{date} {title}/Altar Response",
      "ChurchView/Services/{date} {title}/Invite Post",
      "ChurchView/Services/{date} {title}/Final Exports"
    ],
    suggestedVideos: [
  ...
  },
  {
    ...
    filePaths: [
      ...
      "Social/Longform/Unedited/{date} {title}",
      "Social/Longform/Edited/{date} {title}",
      "ChurchView/Events/{date} {title}/Photos",
      "ChurchView/Events/{date} {title}/Graphics",
      "ChurchView/Events/{date} {title}/Notes",
      "ChurchView/Events/{date} {title}/Final Exports"
    ],
    suggestedVideos: [
...
export const initialData = {
  ...
  activity: [],
  notes: [
    { id: "note-mission", title: "Media mission", body: "Use photography, video, design, and digital storytelling to glorify Jesus Christ, preserve what God is doing, invite people into fellowship, and help the message reach beyond the walls of the building.", pinned: true, createdBy: "System", createdAt: new Date().toISOString() }
  ],
  calendarEvents: weeklyPosts.map((post) => ({ ...post, eventType: "Post", assignedTo: "Denzel", notes: post.type })),
  ...
  presets: [
    { id: "preset-sanctuary-recording", name: "Sanctuary Recording", location: "Sanctuary", purpose: "General service recording", assignedGear: "Main Camera", settings: [{ label: "Frame Rate", value: "24fps" }, { label: "Shutter", value: "1/50" }, { label: "Audio", value: "Board feed if available" }, { label: "Shot", value: "Stable medium/wide" }], notes: "Default preset for sermon and general service capture." },
    { id: "preset-worship-recap", name: "Worship Recap", location: "Sanctuary", purpose: "Movement-heavy worship capture", assignedGear: "Motion / Recap Camera", settings: [{ label: "Frame Rate", value: "60fps" }, { label: "Shutter", value: "1/125" }, { label: "Movement", value: "Slow and stable" }, { label: "Focus", value: "Worship leader, musicians, response" }], notes: "Use restraint. Avoid distracting movement during worship." }
  ],
  access: [
